...
from utils import get_settings, get_size, save_group_settings, temp, verify_user, check_token, check_verification, get_token, get_shortlink, get_tutorial, is_req_subscribed
...
async def start(client, message):
    ...
    if not files_:
        ...
        try:
            ...
            k = await client.send_message(chat_id = message.from_user.id, text=f"<b>❗️ <u>ɪᴍᴘᴏʀᴛᴀɴᴛ</u> ❗️</b>\n\n<b>ᴛʜɪꜱ ꜰɪʟᴇꜱ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ</b> <b><u>10 ᴍɪɴᴜᴛᴇꜱ</u> </b><b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ).</b>\n\n<b><i>📌 ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ꜰɪʟᴇꜱ ᴛᴏ ꜱᴀᴠᴇᴅ ᴍᴀꜱꜱᴀɢᴇ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ.</i></b>")
            await k.react("👨‍💻",big=True)
            await asyncio.sleep(6)
            await msg.delete()
            await k.edit_text("<b>Yᴏᴜʀ Fɪʟᴇꜱ Iꜱ Sᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ !!\n\nᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴅᴇʟᴇᴛᴇᴅ ꜰɪʟᴇꜱ.👇</b>",reply_markup=InlineKeyboardMarkup(btn))
            await k.react("🤝",big=True)
            return
        except:
            pass
    ...
    k = await client.send_message(chat_id = message.from_user.id, text=f"<b>❗️ <u>ɪᴍᴘᴏʀᴛᴀɴᴛ</u> ❗️</b>\n\n<b>ᴛʜɪꜱ ꜰɪʟᴇꜱ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ</b> <b><u>10 ᴍɪɴᴜᴛᴇꜱ</u> </b><b>(Dᴜᴇ Tᴏ Cᴏᴘʏʀɪɢʜᴛ Iꜱꜱᴜᴇꜱ).</b>\n\n<b><i>📌 ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ꜰɪʟᴇꜱ ᴛᴏ ꜱᴀᴠᴇᴅ ᴍᴀꜱꜱᴀɢᴇ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ.</i></b>")
    await k.react("👨‍💻",big=True)
    await asyncio.sleep(6)
    await msg.delete()
    await k.edit_text("<b>Yᴏᴜʀ Fɪʟᴇꜱ Iꜱ Sᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ !!\n\nᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴅᴇʟᴇᴛᴇᴅ ꜰɪʟᴇꜱ.👇</b>",reply_markup=InlineKeyboardMarkup(btn))
