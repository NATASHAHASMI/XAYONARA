class script(object):
    START_TXT = """<b><pre> Hᴇʏ 😇. </pre><i>{}</i> {} </b>
    
<blockquote><b>Iᴍ Tʜᴇ Mᴏsᴛ Aᴅᴠᴀɴᴄᴇ Aɪ Pᴏᴡᴇʀᴅ Bᴏᴛ.🏴‍☠️
...
"""
    ...
    GSTART_TXT = """<b><i>ʜᴇʏ 😎.</i></b> <b>{}</b> <b>ɪ ᴀᴍ ᴘᴏᴡᴇʀꜰᴜʟʟ ᴍᴏᴠɪᴇꜱ & ꜱᴇʀɪᴇꜱ ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴍᴇ ᴀɴʏ ᴍᴏᴠɪᴇꜱ & ꜱᴇʀɪᴇꜱ ɴᴀᴍᴇ.</b>

<spoiler><b><a href="https://i.ibb.co/NSfdfhF/Picsart-23-03-23-17-47-19-046.webp">🔋</a> ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ - <a href='https://telegram.me/xayonara_contact_bot'>✘ 𝐚 𝐲 𝐨 𝐧 𝐚 𝐫 𝐚.</a></b></spoiler>"""
...
ᴅᴏɴ'ᴛ ᴡᴏʀʀʏ 😊 Cʜᴏᴏꜱᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ᴏɴᴇ ʙᴇʟᴏᴡ 👇"""
    ...
    DISCLAIMER_TXT = """
    𝑯𝒆𝒚 {}.😈
    <b><i><pre>Tʜɪꜱ Iꜱ Aɴ Oᴘᴇɴ Sᴏᴜʀᴄᴇ Pʀᴏᴊᴇᴄᴛ.⚡️</pre>
...
<b><spoiler>🔋 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://telegram.me/xayonara_contact_bot'>✘ 𝐚 𝐲 𝐨 𝐧 𝐚 𝐫 𝐚.</a></b></spoiler>"""
...
Any Doubts or Not Connecting? Contact Me <a href='https://t.me/XAYOONARA'>✘ 𝐚 𝐲 𝐨 𝐧 𝐚 𝐫 𝐚.</a></b>"""
...
╰──────────────────────
<b><i>📢 <a href='t.me/Movie_Series_Request_Groups'>Jᴏɪɴ Bᴀᴄᴋᴜᴘ</a></i></b>
"""
